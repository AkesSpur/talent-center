...
class StoreContestRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'entry_fee.required_if'            => 'Укажите сумму оргвзноса для платного конкурса.',
            'entry_fee.min'                    => 'Сумма оргвзноса должна быть не менее 100 рублей и не более 100 000 рублей, без копеек.',
            'entry_fee.max'                    => 'Сумма оргвзноса должна быть не менее 100 рублей и не более 100 000 рублей, без копеек.',
            'entry_fee.integer'                => 'Сумма оргвзноса должна быть целым числом.',
