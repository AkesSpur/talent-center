        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
                @php
                    ...
                    $initialContestAgeGroups = old('contest_age_groups') ?? [];
                        ...
                        >
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <div x-show="!orgCanHostPaid" x-cloak class="mt-1.5 text-xs text-warm-gray leading-snug">
                                        Заполните реквизиты организации и примите оферту.
                                        <span x-show="selectedOrgId">
                                            <a :href="'/organizations/' + selectedOrgId + '/edit'" class="text-primary underline">Редактировать организацию</a>.
                                        </span>
                                    </div>
                                </div>
...
function contestForm(initialCategories, orgsData, preselectedOrgId, diplomaBgData, initialContestAgeGroups, initialJuries, initialGenreId, initialDiplomaBg, contestCoverData, initialCoverPath) {
    return {
        ...
        selectedJuries: (initialJuries || []).map(Number),
        juryInviteEmail: '',
