@php
    ...
    $statusMap = [
        ...
        // Support / helpdesk
        'ticket-created'            => ['Заявка создана', 'success'],
        'ticket-comment-added'      => ['Сообщение отправлено', 'success'],
        'ticket-confirmed'          => ['Спасибо! Заявка закрыта', 'success'],
        'ticket-rated'              => ['Спасибо за оценку', 'success'],
        'ticket-replied'            => ['Ответ отправлен', 'success'],
        'ticket-status-changed'     => ['Статус заявки изменён', 'success'],
        'ticket-category-changed'   => ['Категория заявки изменена', 'success'],
        'ticket-assigned'           => ['Заявка взята в работу', 'success'],
        'support-category-created'  => ['Категория создана', 'success'],
        'support-category-updated'  => ['Категория обновлена', 'success'],
        'support-category-archived' => ['Категория перенесена в архив', 'success'],
