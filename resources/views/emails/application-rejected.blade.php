                    ...
                    <tr>
                        <td>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                {{-- Red accent bar --}}
                                <tr>
                                    <td style="height: 4px; background: linear-gradient(90deg, #EF4444 0%, #DC2626 100%);"></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 16px 40px 24px 40px;">
                                        <p style="margin: 0 0 20px 0; font-size: 15px; color: #2C2416; line-height: 1.6;">
                                            К сожалению, ваша заявка на конкурс <strong>«{{ $contestTitle }}»</strong> была отклонена.
                                        </p>

                                        @if($rejectionReason)
                                            <div style="background-color: #FEF2F2; border-left: 3px solid #EF4444; padding: 16px; border-radius: 0 8px 8px 0; margin-bottom: 20px;">
                                                <p style="margin: 0 0 6px 0; font-size: 12px; font-weight: 600; color: #DC2626; text-transform: uppercase; letter-spacing: 0.05em;">
                                                    Причина отклонения:
                                                </p>
                                            ...
                                            <tr>
                                                <td style="border-top: 1px solid rgba(212, 175, 55, 0.2); padding-top: 20px;">
                                                    <p style="margin: 0; font-size: 13px; color: #9A8B7A; line-height: 1.6;">
                                                        Вы можете участвовать в других конкурсах платформы.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
