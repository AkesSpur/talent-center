{{--
    Shell for the eight support letters.

    The seven older emails each repeat this markup inline. Eight more copies would
    mean editing the footer in fifteen places, so the support set shares one shell.
    The markup below is the same table/palette as emails/application-submitted.blade.php,
    so the letters look identical to the rest of the platform's mail.

    Children set: @section('title'), @section('heading'), @section('content'),
    and optionally @section('cta_url')/@section('cta_label'), @section('note'),
    @section('footer_note').
--}}
<!DOCTYPE html>
<html lang="ru">
                                            ...
                                            <tr>
                                                <td align="center" style="border-radius: 10px; background: linear-gradient(135deg, #D4AF37 0%, #C5A028 50%, #B8960F 100%);">
                                                    <a href="@yield('cta_url', $userUrl)"
                                                        ...
                                                        @yield('cta_label', 'Открыть заявку')
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td align="center" style="padding: 32px 0 0 0;">
                            ...
                            <p style="margin: 0; font-size: 12px; color: #9A8B7A;">
                                @yield('footer_note', 'Это письмо отправлено автоматически. Пожалуйста, не отвечайте на него — вся переписка идёт в личном кабинете.')
                            </p>
                        </td>
                    </tr>
