...
<head>
    ...
    <title>Приглашение в жюри</title>
</head>
                                ...
                                <tr>
                                    <td style="padding: 16px 40px 8px 40px;">
                                        <p style="margin: 0 0 16px 0; font-size: 15px; color: #2C2416; line-height: 1.6;">
                                            Пользователь <strong>{{ $invitedByName }}</strong> приглашает вас стать членом жюри
                                            в организации <strong>«{{ $organizationName }}»</strong> на платформе Талант-центр.
                                        </p>
                                        <p style="margin: 0 0 24px 0; font-size: 15px; color: #2C2416; line-height: 1.6;">
                                            Чтобы принять приглашение, зарегистрируйтесь на платформе по кнопке ниже,
                                            а затем сообщите организатору свой email — и он добавит вас в жюри.
                                        </p>
                                    </td>
                                </tr>
