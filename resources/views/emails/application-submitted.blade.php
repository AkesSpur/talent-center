                                ...
                                <tr>
                                    <td style="padding: 16px 40px 24px 40px;">
                                        <p style="margin: 0 0 16px 0; font-size: 15px; color: #2C2416; line-height: 1.6;">
                                            Ваша заявка на участие в конкурсе <strong>«{{ $contestTitle }}»</strong>
                                            @if($categoryName)
                                                (номинация: {{ $categoryName }})
                                            @endif
                                            успешно принята. Ожидайте результатов оценки.
                                        </p>
                                            ...
                                            <tr>
                                                <td style="border-top: 1px solid rgba(212, 175, 55, 0.2); padding-top: 20px;">
                                                    <p style="margin: 0; font-size: 13px; color: #9A8B7A; line-height: 1.6;">
                                                        Вы получите уведомление, когда результаты будут объявлены.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
